...
def logout():
    ...
    print("\n\t[ https://www.facebook.com/BMX.CEO.MAHIN ]\n")
    sys.exit()
...
def logo():
    ...
    logopsb("\033[3;90m			   created by\033[1;93 BMX [ MAHIN ]\033[0;92m")
    time.sleep(0.6)
    logopsb("\033[34m\n|****************************************************|\n|\033[3m Author   : Mahin [BMX]                             \033[0;34m|\n|\033[3m Tool     : Ascii Logo                              \033[0;34m|\n|\033[3m Version  : 2.1                                     \033[0;34m|\n|\033[3m Link     : https://www.github.com/Toxic-Noob/	     \033[0;34m|\n|\033[3m Coded By : BMX [MAHIN]      		     	     \033[0;34m|\n******************************************************")
    time.sleep(0.8)
